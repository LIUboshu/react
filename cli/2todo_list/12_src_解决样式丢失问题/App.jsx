				...
				<div className="row">
					<div className="col-xs-2 col-xs-offset-2">
						<div className="list-group">
							...
							<MyNavlink to="/haha/about" a={1} b={2}>About</MyNavlink>
							<MyNavlink to="/haha/home">home</MyNavlink>
						</div>
					</div>
					<div className="col-xs-6">
						<div className="panel">
							<div className="panel-body">
								...
								<Switch>
									<Route path="/haha/about" component={About}/>
									<Route path="/haha/home" component={Home}/>
								</Switch>
